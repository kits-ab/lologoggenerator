...
public abstract class WebAccessLogGeneratorData {
    ...
    public static final List<WeightedOption> IP_ADDRESSES = Collections.unmodifiableList(
            Arrays.asList(
    ...
    public static final List<WeightedOption> USERS = Collections.unmodifiableList(
            Arrays.asList(
    ...
    public static final List<WeightedOption> REQUEST_TYPES = Collections.unmodifiableList(
            Arrays.asList(
                    new WeightedOption("POST /users HTTP/1.1", 0.2),
                    new WeightedOption("GET /users/list HTTP/1.1", 0.8)
            )
    );
    public static final List<WeightedOption> STATUS_TYPES = Collections.unmodifiableList(
            Arrays.asList(
    ...
    public static final List<WeightedOption> REFERERS = Collections.unmodifiableList(
            Arrays.asList(
                    new WeightedOption("-", 0.25),
                    new WeightedOption("http://www.kits.se/", 0.75)
            )
    );
    public static final List<WeightedOption> USER_AGENTS = Collections.unmodifiableList(
            Arrays.asList(
